...
import com.example.contacts.databinding.FragmentContact2Binding
...
class ContactViewHolder2(val fragmentNavigator: FragmentNavigator?) : BaseViewHolder {
    ...
    override fun getViewHolder(parent: ViewGroup): BaseViewHolder.ViewHolder {
        val binding =
            FragmentContact2Binding.inflate(
